...
with st.sidebar:
    ...
    st.markdown('<div class="sidebar-tag">AI network troubleshooting workspace</div>', unsafe_allow_html=True)
    st.divider()
...
st.markdown('''<div class="hero-wrap">
  <div class="hero-top"><span class="hero-brand">NETSAGE AI</span><span class="hero-status">EVIDENCE FIRST</span></div>
...
<div class="netsage-author">
    Developed by Samarth Moraiya
</div>
""", unsafe_allow_html=True)